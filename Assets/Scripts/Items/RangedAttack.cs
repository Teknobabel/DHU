...
public class RangedAttack : Item {
	...
	public override IEnumerator Activate ()
	{
		...
		if (eCards.Count > 0)
		{
			...
			if (GameManager.m_gameManager.selectedCard != null)
			{
				...
				{
					string newString = "\\1" + GameManager.m_gameManager.currentFollower.m_nameText + "\\0 uses \\8" + m_name + "\\0 on \\4" + GameManager.m_gameManager.selectedCard.enemy.m_displayName;
					UIManager.m_uiManager.UpdateActions (newString);

					Enemy thisEnemy = GameManager.m_gameManager.selectedCard.enemy;
					StartCoroutine(thisEnemy.TakeDamage(m_damage + Player.m_player.permRangedDamageBonus));
				}
